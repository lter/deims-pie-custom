...
//  This can also be an URL instead of a local file path.
    $xml_folder = DRUPAL_ROOT . '/' . drupal_get_path('module', 'eml_2_deims') . '/xml/unh-river-network/';
...
// Save to the default file scheme.
  ...
  public function prepareRow($row) {
    ...
    $row->file_uri = $base_path . 'sites/default/imports/unh-river-network/' . $filen . '.csv';
