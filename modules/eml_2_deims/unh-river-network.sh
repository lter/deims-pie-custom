...
#General path 
mydir="/home/isangil/www/pie7/www/sites/default/modules/eml_2_deims/xml/unh-river-network"

# Get the names of XML files from the subfolder (land-cover, unh-river-network,..)
xml_files="${mydir}/*.xml"
...
for f in $xml_files
 ...
 do 
  ...
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/unh-river-network/EmlFileMigration.php 1> ./migration/EmlFileMigration.php

  # EmlDataFile Class 
  # Replace the name of eml in the class file 'EMLDataFile.php' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/unh-river-network/EmlDataFileMigration.php 1> ./migration/EmlDataFileMigration.php

  # EmlDataSet Class 
  # Replace the name of eml in the class file 'EMLDataSet' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/unh-river-network/EmlDatasetMigration.php 1> ./migration/EmlDatasetMigration.php
