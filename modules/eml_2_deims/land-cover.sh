...
#General path 
mydir="/home/isangil/www/pie7/www/sites/default/modules/eml_2_deims/xml/land-cover"

# Get the names of XML files from the subfolder (land-cover, idrisi..)
xml_files="${mydir}/*.xml"
...
for f in $xml_files
 ...
 do 
  ...
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/land-cover/EmlFileMigration.php 1> ./migration/EmlFileMigration.php

  # EmlDataFile Class 
  # Replace the name of eml in the class file 'EMLDataFile.php' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/land-cover/EmlDataFileMigration.php 1> ./migration/EmlDataFileMigration.php

  # EmlDataSet Class 
  # Replace the name of eml in the class file 'EMLDataSet' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/land-cover/EmlDatasetMigration.php 1> ./migration/EmlDatasetMigration.php
